Ext.define('User', {
    ...
    proxy: {
	type: 'rest',
	url : '/cms/api?object=Office_loadUser',
...
Ext.define('Strings', {
    ...
    proxy: {
	type: 'rest',
	url : '/cms/api?object=object=Office_loadUser',
	reader: {
	    type: 'json',
	    root: 'strings'
	}
...
Ext.define('MyDesktop.MyExtDesk', {
	...
	User.load('', {
		...
		Ext.getDom('idTheme').href= getPath + "/media/cms/extjs/resources/css/ext-all-"+this.user.get('theme')+".css";
		//***<(8D>
