...
Ext.define('MyDesktop.ExtDesk', {
    ...
    init: function() {
		...
		this.wallPaper = '/media/cms/resources/wallpapers/'+this.userStore.get("wallPaper")+'.jpg';
	...
	loadCss : function(filename){
		...
		file='/media/cms/modules/'+filename+'/Client/Resources/'+filename+'.css';
        ...
        Ext.Msg.confirm(this.lang["logout"],this.lang["areYouSure"],function(btn, text){
			if (btn == 'yes'){
				// process text value and close...
					Ext.Ajax.request({
						url: '/cms/api?object=User_Logout',
