...
Ext.define('MyDesktop.Settings', {
    ...
    initComponent: function () {
		...
		**/
		...
		me.store=Ext.create('Ext.data.Store', {
			...
			model: 'set_mod_image',
			data: [
				{id : 'wallpaper', 	src:'/media/cms/resources/images/tango/preferences-desktop-wallpaper_48x48.png', 	title :this.lang["wallpaper"],		caption : this.lang["wallpaper_label"]},
				{id : 'shortcut',  	src:'/media/cms/resources/images/tango/preferences-desktop-shorcut_48x48.png',		title :this.lang["shortcut"],		caption : this.lang["shortcut_label"]},
				{id : 'qLaunch', 	src:'/media/cms/resources/images/tango/preferences-desktop-quick-launch_48x48.png',title :this.lang["quicklaunch"],	caption : this.lang["quicklaunch_label"]},
				{id : 'themes', 	src:'/media/cms/resources/images/tango/preferences-desktop-theme_48x48.png', 		title :this.lang["themes"],			caption : this.lang["themes_label"]}
				]
		});
	...
	openTabTheme : function(){
		...
		selectTheme='/media/cms/resources/themes/'+selectTheme.replace(".css",".jpg");
 ...
 */
    ...
    onSelectWallpaper: function (tree, record) {
        ...
        if (record.data.img) {
            me.selected = '/media/cms/resources/wallpapers/' + record.data.img;
        } else {
    ...
    setInitialSelection: function () {
        ...
        if (s) {
            var path = '/media/cms/resources/wallpapers/' + this.getTextOfWallpaper(s);
    ...
    onSelectTheme : function (tree, record) {
        ...
        if (record.data.img) {
            me.selectedTheme = '/media/cms/resources/themes/' + record.data.img;
        } else {
