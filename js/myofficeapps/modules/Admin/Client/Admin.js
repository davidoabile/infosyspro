...
Ext.define('MyDesktop.Modules.Admin.Client.Admin', {			// 1.- Steep One define the name of the module
    ...
    loadCss : function(filename){
        file= 'jsfrw/myofficeapps/'+filename+'.css';
    ...
    init : function(){
        ...
        me.store = Ext.create('Ext.data.Store', {
            ...
            {
                id : 'option1ex', 
                src:'/jsfrw/myofficeapps/modules/Admin/Client/Resources/images/system-users_48x48.png', 	
                title : this.lang["userCaption"] ,	
                caption : this.lang["userLegend"]
            },
{
                id : 'option1ex', 
                src:'/jsfrw/myofficeapps/modules/Admin/Client/Resources/images/modules_48x48.png', 	
                ...
                {
                id : 'option1ex', 
                src:'/jsfrw/myofficeapps/modules/Admin/Client/Resources/images/groups_48x48.png', 	
