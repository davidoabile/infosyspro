Ext.define('User', {
    ...
    proxy: {
	type: 'rest',
	url : '/myofficeapps/api?object=Office_loadUser',
...
Ext.define('Strings', {
    ...
    proxy: {
	type: 'rest',
	url : '/myofficeapps/api?object=object=Office_loadUser',
	reader: {
	    type: 'json',
	    root: 'strings'
	}
...
Ext.define('MyDesktop.MyExtDesk', {
	...
	User.load('', {
		...
		Ext.getDom('idTheme').href= getPath + "/jsfrw/myofficeapps/extjs/resources/css/ext-all-"+this.user.get('theme')+".css";
		//***<(8D>
