...
Ext.define('MyDesktop.Settings', {
    ...
    initComponent: function () {
		...
		**/
		...
		me.store=Ext.create('Ext.data.Store', {
			...
			model: 'set_mod_image',
			data: [
				{id : 'wallpaper', 	src:'/jsfrw/cms/resources/images/tango/preferences-desktop-wallpaper_48x48.png', 	title :this.lang["wallpaper"],		caption : this.lang["wallpaper_label"]},
				{id : 'shortcut',  	src:'/jsfrw/cms/resources/images/tango/preferences-desktop-shorcut_48x48.png',		title :this.lang["shortcut"],		caption : this.lang["shortcut_label"]},
				{id : 'qLaunch', 	src:'/jsfrw/cms/resources/images/tango/preferences-desktop-quick-launch_48x48.png',title :this.lang["quicklaunch"],	caption : this.lang["quicklaunch_label"]},
				{id : 'themes', 	src:'/jsfrw/cms/resources/images/tango/preferences-desktop-theme_48x48.png', 		title :this.lang["themes"],			caption : this.lang["themes_label"]}
				]
		});
	...
	openTabTheme : function(){
		...
		selectTheme='/jsfrw/cms/resources/themes/'+selectTheme.replace(".css",".jpg");
 ...
 */
    ...
    onSelectWallpaper: function (tree, record) {
        ...
        if (record.data.img) {
            me.selected = '/jsfrw/cms/resources/wallpapers/' + record.data.img;
        } else {
    ...
    setInitialSelection: function () {
        ...
        if (s) {
            var path = '/jsfrw/cms/resources/wallpapers/' + this.getTextOfWallpaper(s);
    ...
    onSelectTheme : function (tree, record) {
        ...
        if (record.data.img) {
            me.selectedTheme = '/jsfrw/cms/resources/themes/' + record.data.img;
        } else {
