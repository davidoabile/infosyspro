...
Ext.define('MyDesktop.ExtDesk', {
    ...
    init: function() {
		...
		this.wallPaper = '/jsfrw/myofficeapps/resources/wallpapers/'+this.userStore.get("wallPaper")+'.jpg';
	...
	loadCss : function(filename){
		...
		file='/jsfrw/myofficeapps/modules/'+filename+'/Client/Resources/'+filename+'.css';
