 ...
 *
 * @category   TbAclResources
 * @package    Infosyspro_TbAclResources
 * @subpackage TbAclResources
...
/**
 * This class handles all TbAclResources detecttion using php get_browser()
 * 
 */
class TbAclResources extends TableGateway
{
    
    protected $table = 'TbAclResources' ;
    protected $tableName = 'TbAclResources' ;
